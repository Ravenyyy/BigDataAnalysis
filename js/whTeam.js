...
function edu_1 () {
    ...
    var data = {
        edu: [
            [100, 100, 93, 100, 100, 100, 100, 89, 100, 92, 96, 100, 93, 100, 81],
            [95.7, 95.1, 98.2, 94.5, 99.2, 97.8, 93.3, 95.7, 99.1, 90.2, 92.2, 89.2, 93.6, 97.5, 89.2]
        ]
    };
    // 指定配置和数据
    option = {
...
function tb_wn1 () {
    ...
    $.ajax({
        type: 'GET',
        url: localStorage.getItem("url") + 'warning/getWarningByZhidui',
        data: {
